...
class insert_ranges_manual extends moodleform {
    ...
    protected function definition() {
        ...
        $mform->addElement('header', 'manualHeader',
         get_string('manual_insertion_header', 'local_restrict'));
        ...
        $mform->addElement('textarea', 'manualIps', get_string('ips', 'local_restrict'),
         ['placeholder' => get_string('manual_ip_place', 'local_restrict'), 'rows="10" cols="10"']);
